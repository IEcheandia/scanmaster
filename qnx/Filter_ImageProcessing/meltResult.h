...
#ifndef MELTRESULT_INCLUDED_H_
#define MELTRESULT_INCLUDED_H_
 ...
 */
class FILTER_API MeltResult : public fliplib::TransformFilter
{
public:
	...
	static const std::string m_oPipeOutAdditionalMaterialWidthName;	///< Pipe name: out-pipe.
	static const std::string m_oPipeOutAdditionalMaterialHeightName;///< Pipe name: out-pipe.
...
private:
	...
	fliplib::SynchronePipe< interface::GeoDoublearray >		m_oPipeOutAdditionalMaterialWidth;	///< Data out-pipe.
	fliplib::SynchronePipe< interface::GeoDoublearray >		m_oPipeOutAdditionalMaterialHeight;	///< Data out-pipe.
