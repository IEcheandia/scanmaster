...
#ifndef ENCODERPOSITIONSOURCE_H_
#define ENCODERPOSITIONSOURCE_H_
...
class FILTER_API EncoderPositionSource : public fliplib::SourceFilter
{
public:
...
#endif /*ENCODERPOSITIONSOURCE_H_*/
