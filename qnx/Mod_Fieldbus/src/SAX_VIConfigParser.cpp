    ...
    _pLocator(0)
{
    ...
    m_oInfoS6KSystemFault.m_oPresent = false;
    m_oInfoS6KSystemReady.m_oPresent = false;
}
...
void SAX_VIConfigParser::getS6KSystemFaultInfo(struct InfoStruct &p_rSystemFaultInfo)
{
    p_rSystemFaultInfo.m_oPresent = m_oInfoS6KSystemFault.m_oPresent;
    p_rSystemFaultInfo.m_oProductCode = m_oInfoS6KSystemFault.m_oProductCode;
    p_rSystemFaultInfo.m_oVendorID = m_oInfoS6KSystemFault.m_oVendorID;
    p_rSystemFaultInfo.m_oSlaveType = m_oInfoS6KSystemFault.m_oSlaveType;
    p_rSystemFaultInfo.m_oInstance = m_oInfoS6KSystemFault.m_oInstance;
    p_rSystemFaultInfo.m_oStartBit = m_oInfoS6KSystemFault.m_oStartBit;
    p_rSystemFaultInfo.m_oLength = m_oInfoS6KSystemFault.m_oLength;
}

void SAX_VIConfigParser::getS6KSystemReadyInfo(struct InfoStruct &p_rSystemReadyInfo)
{
    p_rSystemReadyInfo.m_oPresent = m_oInfoS6KSystemReady.m_oPresent;
    p_rSystemReadyInfo.m_oProductCode = m_oInfoS6KSystemReady.m_oProductCode;
    p_rSystemReadyInfo.m_oVendorID = m_oInfoS6KSystemReady.m_oVendorID;
    p_rSystemReadyInfo.m_oSlaveType = m_oInfoS6KSystemReady.m_oSlaveType;
    p_rSystemReadyInfo.m_oInstance = m_oInfoS6KSystemReady.m_oInstance;
    p_rSystemReadyInfo.m_oStartBit = m_oInfoS6KSystemReady.m_oStartBit;
    p_rSystemReadyInfo.m_oLength = m_oInfoS6KSystemReady.m_oLength;
}
...
void SAX_VIConfigParser::ClearTempValues()
{
    ...
    m_parseSetS6KSystemFaultStatus = false;
    m_parseSetS6KSystemReadyStatus = false;
...
void SAX_VIConfigParser::startElement(const XMLString& uri,
    ...
    // S6K_SystemFault
    if (strcmp("S6K_SystemFault", localName.c_str()) == 0)
    {
        m_parseSetS6KSystemFaultStatus = true;
    }
    // S6K_SystemReady
    if (strcmp("S6K_SystemReady", localName.c_str()) == 0)
    {
        m_parseSetS6KSystemReadyStatus = true;
    }
...
//    }
    ...
    else if (strcmp("Output", localName.c_str()) == 0)
    {
        ...
        if(m_parseSetS6KSystemFaultStatus)
        {
            if ((m_tempSlaveType == 0) ||
                (m_tempProductCode == 0) ||
                (m_tempVendorID == 0) ||
                (m_tempInstance == 0))
            {
                ...
                wmLogTr(eError, "QnxMsg.VI.VIConfErr2", "Signal <%s> is not activated!\n", "S6K_SystemFault");
                m_oInfoS6KSystemFault.m_oPresent = false;
                m_oInfoS6KSystemFault.m_oProductCode = 0;
                m_oInfoS6KSystemFault.m_oVendorID = 0;
                m_oInfoS6KSystemFault.m_oSlaveType = 0;
                m_oInfoS6KSystemFault.m_oInstance = 0;
                m_oInfoS6KSystemFault.m_oStartBit = 0;
                m_oInfoS6KSystemFault.m_oLength = 0;
            }
            else
            {
                m_oInfoS6KSystemFault.m_oPresent = true;
                m_oInfoS6KSystemFault.m_oProductCode = m_tempProductCode;
                m_oInfoS6KSystemFault.m_oVendorID = m_tempVendorID;
                m_oInfoS6KSystemFault.m_oSlaveType = m_tempSlaveType;
                m_oInfoS6KSystemFault.m_oInstance = m_tempInstance;
                m_oInfoS6KSystemFault.m_oStartBit = m_tempStartBit;
                m_oInfoS6KSystemFault.m_oLength = m_tempLength;
            }
        }
        if(m_parseSetS6KSystemReadyStatus)
        {
            if ((m_tempSlaveType == 0) ||
                (m_tempProductCode == 0) ||
                (m_tempVendorID == 0) ||
                (m_tempInstance == 0))
            {
                ...
                wmLogTr(eError, "QnxMsg.VI.VIConfErr2", "Signal <%s> is not activated!\n", "S6K_SystemReady");
                m_oInfoS6KSystemReady.m_oPresent = false;
                m_oInfoS6KSystemReady.m_oProductCode = 0;
                m_oInfoS6KSystemReady.m_oVendorID = 0;
                m_oInfoS6KSystemReady.m_oSlaveType = 0;
                m_oInfoS6KSystemReady.m_oInstance = 0;
                m_oInfoS6KSystemReady.m_oStartBit = 0;
                m_oInfoS6KSystemReady.m_oLength = 0;
            }
            else
            {
                m_oInfoS6KSystemReady.m_oPresent = true;
                m_oInfoS6KSystemReady.m_oProductCode = m_tempProductCode;
                m_oInfoS6KSystemReady.m_oVendorID = m_tempVendorID;
                m_oInfoS6KSystemReady.m_oSlaveType = m_tempSlaveType;
                m_oInfoS6KSystemReady.m_oInstance = m_tempInstance;
                m_oInfoS6KSystemReady.m_oStartBit = m_tempStartBit;
                m_oInfoS6KSystemReady.m_oLength = m_tempLength;
            }
        }
    }
}
