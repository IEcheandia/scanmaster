 ...
 * @brief This filter retrieves data elements from a global a buffer. The data elements were stored in the buffer by the BufferRecorder filter.
 */
class FILTER_API SetPosition : public fliplib::TransformFilter
{
public:
...
protected:
	...
	fliplib::SynchronePipe< interface::ImageFrame >			m_oPipeOutImage;			///< Data out-pipe.
