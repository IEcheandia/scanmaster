...
#ifndef POSDISPLAYWITHRANK_H_
#define POSDISPLAYWITHRANK_H_
 ...
 * @brief This filter visualizes a position using overlay primitives.
 */
class FILTER_API PosDisplayWithRank : public fliplib::TransformFilter
{
public:
...
protected:
    ...
    bool m_oHandleDifferentContext;

}; // class PosDisplayWihtRank

} // namespace filter
} // namespace precitec

#endif // POSDISPLAYWITHRANK_H_
