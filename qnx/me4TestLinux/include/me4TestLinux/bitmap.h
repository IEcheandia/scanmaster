...
public:
	 ...
	 *
	 */
	bool validSize() const { return ( (header_.width > 0) && (header_.height > 0) ); }
	 ...
	 * erledigt werden!
	 * \param	data				Zeiger auf Speicher der mindestens dataSize() gross ist
	 * @param	p_rAdditionalData	Lädt zusätzliche Daten, die vor das Pixelarray geschrieben wurden, falls vorhanden. Passt die Groesse des Vektors an.
