...
#include "productTeachInServer.h"
#include "weldHeadMsgProxy.h"
...
namespace Simulation
{
	...
	private:
		...
		// Versucht die Verbindungen zum Host aufzubauen
        void initGrabberForSimulation();
	...
	private:
		...
		Simulation::ProductTeachInServer		productTeachInProxy_;

		//MsgProxy fuer weldHeadMsg
		Simulation::WeldHeadMsgServer			weldHeadMsgProxy_;
        ...
        CommandServer m_simulationCmdServer;
        TSimulationCmd<MsgHandler> m_simulationCmdHandler;
