...
static inline const char *defaultFifoPath()
{
    static std::string s_defaultFifoPath = std::string(getenv("XDG_RUNTIME_DIR") + std::string("/fifo/") + std::string("/"));
    return s_defaultFifoPath.c_str();
}
...
#define MAX_PROGRAM_NAME_LEN		51
...
#define	REMOVE						1
#define NO_REMOVE					0
#define DEFAULT_FIFO_PATH           defaultFifoPath()
