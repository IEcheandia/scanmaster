...
int name_attach(const char *, void (*myExit)(), WHO_AM_I&);
int name_detach(WHO_AM_I&);
int child_detach(WHO_AM_I&);
int name_locate(const char *, WHO_AM_I&);
int sur_detach(int, WHO_AM_I&);
int Receive(char **, void *, unsigned, int64_t&, WHO_AM_I&);
int Send(int, void *, void *, unsigned, unsigned, WHO_AM_I&);
int Trigger(int, int, WHO_AM_I&);
int Reply(char *, void *, unsigned, int64_t&, WHO_AM_I&);
int Relay(char *, int, int64_t&, WHO_AM_I&);
char *whatsMyName(WHO_AM_I&);
int whatsMyRecvfd(WHO_AM_I&);
int whatsMyReplyfd(WHO_AM_I&);
char *whatsMyError(void);
char *whatsThisShmPtr(char *);
char *whatsMyShmPtr(WHO_AM_I&);
void simplRcopy(char *, void *, unsigned);
void simplScopy(void *, unsigned, WHO_AM_I&);
