 ...
 * Module     :  ips2                           Version:                 *
 * Filename   :  LEDdriverHW_PP520.cpp         Author : KIH             *
 *                                                                       *
...
const LEDI_ParametersInternT LEDdriverHW_PP520T::internal_parameters(80,200,1);

LEDdriverHW_PP520T::LEDdriverHW_PP520T()
{
	minChannelNumber = 1;
	maxChannelNumber = 2;
...
int LEDdriverHW_PP520T::init(LEDcomBaseT * comin,LEDdriverParameterT & LEDdriverParameter, int iLEDmaxCurrSet[])
{
	printf("LEDdriverHW_PP520T::init\n");
	int i;
	char str[1000];
	double dLEDrating[8];
...
void LEDdriverHW_PP520T::deinit()
{
	int channelnumber;
	int percentage = 0;
...
void LEDdriverHW_PP520T::printstate() // wird derzeit nicht aufgerufen
{
	printf("err=%d\n", error);
	printf("state=%d\n", state);
}

void LEDdriverHW_PP520T::initChannel(int channelnumber, int brightness)
{
...
int LEDdriverHW_PP520T::updateChannel(int channelnumber,LEDI_ParametersT *mypars)
{
...
int LEDdriverHW_PP520T::updateChannelAll(LEDI_ParametersT *mypars)
{
    return -1;
}

void LEDdriverHW_PP520T::deinitchannel(int channelnumber)
{
}

int LEDdriverHW_PP520T::writeSetupPersistent()
{
	char oCommandString[1000];
	char oReturnString[1000];
...
int LEDdriverHW_PP520T::ReFlashDriver(double ras[],int nCannels)
{
	char str1[1000];
	char str2[1000];
	int i,channelnumber;
...
int LEDdriverHW_PP520T::MeasureLightRating(lightRatingStructureT *ras,int nCannels)
{
	char str1[1000];
	char str2[1000];
	int i;
...
int LEDdriverHW_PP520T::ExtractIntensityValues(int IntensityArray[], int nCannels)
{
	char oCommandString[1000];
	char oReturnString[1000];
	int i;
	char *tp1,*tp2,*tp3;
	char oStatusChan[2][200];
	double oHelpFloat;
	...
	// Trennen in 2 einzelne Strings, fuer jeden Kanal einen
...
int LEDdriverHW_PP520T::CheckConnection(void)
{
	char str1[1000];
	char str2[1000];
...
int LEDdriverHW_PP520T::ReadVersion(void)
{
	char str1[1000];
	char str2[1000];
...
printf("ReadVersion: str2 (VR):\n%s\n",str2);
    ...
    {
        printf("There is a PP520 present -> ok !\n");
    }
...
int LEDdriverHW_PP520T::ReadConfiguration(void)
{
	char str1[1000];
	char str2[1000];
