...
#ifndef PORECLASSIFIER_H_
#define PORECLASSIFIER_H_
...
enum FeatureType { 
	...
	eGradient, 
	eSurface, 
	eFeatureTypeMin	= eBoundingBoxDX,
	eFeatureTypeMax	= eSurface, 
	eNbFeatureTypes	= eFeatureTypeMax + 1 
	};
 ...
 */
class FILTER_API PoreClassifier : public fliplib::ResultFilter
{
public:
...
private:
	 ...
	 */
	class FeatureRange;
	unsigned int classify(const FeatureRange&	p_rFeatureRange);
	...
	scalar_result_pipe_t		m_oPipeResult;				///< Result out-pipe.
