...
#include "../src/laserControlProductModel.h"
...
using precitec::gui::LaserControlProductModel;
...
class LaserControlProductModelTest : public QObject
{
    Q_OBJECT
private Q_SLOTS:
    void testCtor();
...
void LaserControlProductModelTest::testCtor()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testRoleNames()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testDisplayRole_data()
{
...
void LaserControlProductModelTest::testDisplayRole()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testPreset_data()
{
    QTest::addColumn<int>("row");
...
void LaserControlProductModelTest::testPreset()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testUuid_data()
{
    QTest::addColumn<int>("row");
...
void LaserControlProductModelTest::testUuid()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testSetProduct()
{
    LaserControlProductModel model{this};

    QSignalSpy productChangedSpy(&model, &LaserControlProductModel::productChanged);
    QVERIFY(productChangedSpy.isValid());

    auto product = new Product{QUuid::createUuid()};
    QVERIFY(product);
    ...
    QVERIFY(ps);
    QCOMPARE(product->hardwareParameters(), ps);
    QCOMPARE(model.getParameterSet(), ps);

    product->deleteLater();
    QVERIFY(productChangedSpy.wait());
    QCOMPARE(model.product(), nullptr);
    QCOMPARE(productChangedSpy.count(), 2);
}

void LaserControlProductModelTest::testSetAttributeModel()
{
    LaserControlProductModel model{this};
    QSignalSpy attributeModelChangedSpy(&model, &LaserControlProductModel::attributeModelChanged);
...
void LaserControlProductModelTest::testSetCurrentPreset()
{
    LaserControlProductModel model{this};
    QSignalSpy presetChangedSpy(&model, &LaserControlProductModel::currentPresetChanged);
...
void LaserControlProductModelTest::testSetLaserControlPresetDir()
{
    LaserControlProductModel model{this};
    QSignalSpy dirChangedSpy(&model, &LaserControlProductModel::laserControlPresetDirChanged);
...
void LaserControlProductModelTest::testFindAttribute()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testFindParameter()
{
    LaserControlProductModel model{this};
...
void LaserControlProductModelTest::testUpdateHardwareParameters()
{
    LaserControlProductModel model{this};

    QSignalSpy markAsChangedSpy(&model, &LaserControlProductModel::markAsChanged);
    ...
    QVERIFY(product->hardwareParameters());
    auto& parameters = product->hardwareParameters()->parameters();
    ...
    auto twoChannelParameters = product->hardwareParameters()->parameters();
...
void LaserControlProductModelTest::testFindPreset()
{
    LaserControlProductModel model{this};
    QSignalSpy presetChangedSpy(&model, &LaserControlProductModel::currentPresetChanged);
    QVERIFY(presetChangedSpy.isValid());

    QSignalSpy rowsInsertedSpy(&model, &LaserControlProductModel::rowsInserted);
    ...
    product->setLaserControlPreset("7d1a636b-5de7-47f9-9e03-a917dc3c2f1d");
    model.init();
...
void LaserControlProductModelTest::testFindPresetTwoChannels()
{
    LaserControlProductModel model{this};
    QSignalSpy presetChangedSpy(&model, &LaserControlProductModel::currentPresetChanged);
    QVERIFY(presetChangedSpy.isValid());
...
void LaserControlProductModelTest::testCreateCurrentPreset()
{
    LaserControlProductModel model{this};
    QSignalSpy presetChangedSpy(&model, &LaserControlProductModel::currentPresetChanged);
    QVERIFY(presetChangedSpy.isValid());
...
void LaserControlProductModelTest::testRemoveCurrentPreset()
{
    LaserControlProductModel model{this};
    QSignalSpy presetChangedSpy(&model, &LaserControlProductModel::currentPresetChanged);
    QVERIFY(presetChangedSpy.isValid());
    ...
    QSignalSpy rowsRemovedSpy(&model, &LaserControlProductModel::rowsRemoved);
    QVERIFY(rowsRemovedSpy.isValid());

    QSignalSpy modelResetSpy(&model, &LaserControlProductModel::modelReset);
    QVERIFY(modelResetSpy.isValid());
...
void LaserControlProductModelTest::testLoad()
{
    LaserControlProductModel model{this};
    QSignalSpy resetSpy(&model, &LaserControlProductModel::modelReset);
    QVERIFY(resetSpy.isValid());
    QSignalSpy rowsInsertedSpy(&model, &LaserControlProductModel::rowsInserted);
    QVERIFY(rowsInsertedSpy.isValid());
    QSignalSpy loadingFinishedSpy(&model, &LaserControlProductModel::loadingFinished);
...
void LaserControlProductModelTest::testPresetEnabled()
{
    LaserControlProductModel model{this};

    QSignalSpy presetEnabledChangedSpy(&model, &LaserControlProductModel::presetEnabledChanged);
    ...
    model.setCurrentPreset(1);
    QCOMPARE(model.currentPreset(), 1);
    QCOMPARE(product->laserControlPreset(), QUuid());
    QVERIFY(product->hardwareParameters());
    auto parameters = product->hardwareParameters()->parameters();
    ...
    parameters = product->hardwareParameters()->parameters();
    QCOMPARE(parameters.size(), 17);
    ...
    auto product2 = new Product{QUuid::createUuid()};
    QVERIFY(product2);
    QVERIFY(!product2->hardwareParameters());
...
void LaserControlProductModelTest::testDelay()
{
    LaserControlProductModel model{this};

    QSignalSpy delayEnabledChangedSpy(&model, &LaserControlProductModel::delayEnabledChanged);
...
void LaserControlProductModelTest::testChannelTwo()
{
    LaserControlProductModel model{this};
    ...
    QSignalSpy channel2EnabledChangedSpy(&model, &LaserControlProductModel::channel2EnabledChanged);
    ...
    QVERIFY(product->hardwareParameters());
    QCOMPARE(product->hardwareParameters()->parameters().size(), 17);
...
QTEST_GUILESS_MAIN(LaserControlProductModelTest)
#include "laserControlProductModelTest.moc"
