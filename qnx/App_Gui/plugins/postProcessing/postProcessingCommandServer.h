...
class PostProcessingCommandServer : public TSimulationCmd<MsgServer>
{
public:
    explicit PostProcessingCommandServer(TTriggerCmd<AbstractInterface> *triggerCmdProxy, analyzer::CentralDeviceManager *deviceManager, const workflow::SharedProductListProvider& stateContext);
    ~PostProcessingCommandServer() override;
