...
#include "../App_Gui/src/simulationImageModel.h"
...
class PostProcessingController : public QObject
{
    Q_OBJECT
...
public:
    explicit PostProcessingController(QObject *parent = nullptr);
    ~PostProcessingController() override;
    ...
    Q_INVOKABLE void processAllFrames();
    Q_INVOKABLE postprocessing::PostProcessing* create(if_ttrigger_cmd_t* p_pTriggerCmdProxy,if_tresults_t*	p_pResultProxy,if_tsystem_status_t* p_pSystemStatusProxy);
