...
#ifndef SELECTPEAKSXT_20110712_H_
#define SELECTPEAKSXT_20110712_H_
 ...
 */
class FILTER_API SelectPeaksXT  : public fliplib::TransformFilter
{
public:
	SelectPeaksXT();
...
private:
    ...
    */
	...
	const scalar_pipe_t*			m_pPipeInDefaultSeamWidth;	///< in pipe image size
...
#endif /*SELECTPEAKSXT_20110712_H_*/
