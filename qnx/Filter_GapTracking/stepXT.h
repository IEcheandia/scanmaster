...
class FILTER_API StepXT : public fliplib::TransformFilter
{
...
public:
	...
	static const std::string PIPENAME_IN1;		///< Name IN-Pipe
	static const std::string PIPENAME_IN2;		///< Name IN-Pipe
...
private:
	...
	const fliplib::SynchronePipe< interface::GeoDoublearray > * 	m_oPipeInAngle;			///< In pipe
	const fliplib::SynchronePipe< interface::GeoDoublearray > *		m_oPipeInHeight;		///< In pipe
	...
	bool															m_oLeft;
	double															m_oHeight;
	double															m_oHeightTolNegative;
	double															m_oHeightTolPositive;
